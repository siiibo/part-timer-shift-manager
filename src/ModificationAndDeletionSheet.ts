...
const isModification = (row: ModificationOrDeletionSheetRow): row is ModificationSheetRow =>
  row.type === "modification";
const isDeletion = (row: ModificationOrDeletionSheetRow): row is DeletionSheetRow => row.type === "deletion";
